...
Partial Public Class EVTurnout_FIL
    ...
    Private Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            e.Row.Cells(0).Text = "Pinag-ipong Kabuuan"
    ...
    Private Sub GetEVTurnoutGridResults()
        ...
        Try
            ...
            sSQL = "select upper(replace(replace(upper(substr(elecname,6,length(elecname)-5)),'PRIMARY ELECTION','PANGUNAHING HALALAN'),'GENERAL ELECTION','PANGKALAHATANG HALALAN'))||' '||substr(elecname,1,4) from cl_web_election where default_elec='Y'"
            'sSQL = "select upper(replace(replace(upper(substr(elecname,6,length(elecname)-5)),'MUNICIPAL PRIMARY','PANGUNAHING HALALAN PANG MUNISPAL NG'),'MUNICIPAL GENERAL','PANGKALAHATANG HALALAN PANG MUNISPAL NG'))||' '||substr(elecname,1,4) from cl_web_election where default_elec='Y'"

            Dim cmd As New OracleCommand(sSQL)
            cmd.Connection = cn
            cn.Open()
            lblElection.Text = cmd.ExecuteScalar & "<br>Nagsiboto sa Maagang Halalan"
            ...
            If iSessions > 0 Then
                ...
                'Dim sUrl As String = "EV_Schedules/" & sElectionCode & "_EV_SCHED_FIL.pdf"
                'Dim hlSched As New HyperLink

                'hlSched.Text = "Takdaan ng Maagang Botohan"
                ...
                If iSessions > 14 And (sElectionType = "G1" Or sElectionType = "P1") Then
                    ...
                    If rdr.HasRows Then
                        ...
                        lblTextNLV.Text = "Lugar ng Pagboboto sa Loob ng Opisina"
                ...
                If iSessions < 8 Then
                    ...
                    lblWeek1.Text = "Pang-araw-araw ng boto"
                ElseIf iSessions = 14 Then
                    sSQL = "select dtSession, rownum from (select dtSession from (select distinct to_char(ev_session, 'mm/dd') " & _
                        "dtSession from cl_ev_turnout where election_code='" & sElectionCode & "' order by 1) order by 1) " & _
                        "where rownum <= " & (iSessions - 7) & " order by 1"
                    lblWeek1.Text = "Pang-araw-araw ng boto - Pang Unang Linggo"
                Else
                ...
                If rdr.HasRows Then
                    ...
                    lblText1.Text = "Lugar ng Maagang Botohan"
                    ...
                    If iSites > 1 Then
                        lblText1.Text = "Mga Kabuuan"
                    Else
                        lblText1.Text = "Kabuuan"
                    End If
                    ...
                    If iSites > 1 Then
                        ...
                        lblText1.Text = "Pang-araw-araw ng boto"
                        tc1.Controls.Add(lblText1)
                        tc1.Wrap = False
                        tc1.Font.Bold = True
                        tc1.BackColor = Drawing.Color.LightGray
                ...
                Else
                    ...
                    If rdr.HasRows Then
                        ...
                        lblText2.Text = "Lugar ng Maagang Botohan"
                        ...
                        lblText2.Text = "Pang-araw-araw na mga kabuuan"
                        tc2.Controls.Add(lblText2)
                        tc2.Wrap = False
                        tc2.Font.Bold = True
                        tc2.BackColor = Drawing.Color.LightGray
