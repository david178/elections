              ...
              <div id="refinePopUp_Mid">
                  ...
                  <!-- Check/Uncheck All -->
                    <div class=“centerPull”>
                      <!-- Show All Link -->
                      <a class="bold"  ng-click="showAllResults()" >Show All&nbsp</a>
                      <div style="font-weight: bold; display: inline-block; ">/</div>
                      <!-- None Link -->
                      <a class="bold"  ng-click="showNoResults()" >&nbspNone</a>
                    </div>
                  ...
                  <ul>
                    ...
                    <li>
  					...
  					<label for="administratorBox" name="administratorBox_lbl" class="css-label">&nbspAdministrator</label>
                         </div>
                    </li>
                    <li>
                        <div class=“setting”>
                       <input id="supremeBox" class="css-checkbox" type="checkbox" ng-model="supreme" ng-change="storageChange(supreme, 'supreme')" />
  					 <label for="supremeBox" name="supremeBox_lbl" class="css-label">&nbspSupreme</label>
                      </div>
                     </li>
                    ...
                    <li>
  					...
  					<label for="peaceBox" name="peaceBox_lbl" class="css-label">&nbspPeace</label>
                         </div>
                    </li>
                     <li>
                        <div class=“setting”>
                       <input id="questionBox" class="css-checkbox" type="checkbox" ng-model="question" ng-change="storageChange(question, 'question')" />
  					 <label for="questionBox" name="questionBox_lbl" class="css-label">&nbspQuestion</label>
                      </div>
                     </li>
                    </ul>
                    </div>
