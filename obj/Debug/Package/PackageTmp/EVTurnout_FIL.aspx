<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EVTurnout_FIL.aspx.vb" Inherits="ElectionResults.EVTurnout_FIL" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Buod ng Nagsiboto sa Maagang Botohan</title>
                    ...
                    <asp:TableCell HorizontalAlign="Center">
                        <asp:Table ID="tblSummary" runat="server" BorderStyle="None" BorderWidth="0" CellPadding="2"
                            ...
                            <%-- %><asp:TableRow ID="tblCityTotals" runat="server">
                                <asp:TableCell HorizontalAlign="Center">
                                    <br />
                                    <font size="medium"><strong>Kabuuan ng Lahat na Dumalo bawat Lungsod</strong></font><br />
                                    <br />
                                    ...
                                    <asp:GridView ID="grdCityTotals" runat="server" CellPadding="3" AutoGenerateColumns="False"
                                        ...
                                        <RowStyle Font-Bold="False" Font-Names="Verdana" Font-Size="Small" HorizontalAlign="Left"
                                            VerticalAlign="Top" />
                                        <Columns>
                                            <asp:BoundField DataField="CITY" HeaderText="Lungsod" HtmlEncode="true"
                                                HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="left">
                                                <ItemStyle Wrap="False" Width="150px" HorizontalAlign="left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="TURNOUT" HeaderText="Kinalabasan" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <asp:TableCell HorizontalAlign="Center">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="3" AutoGenerateColumns="False"
                                        ...
                                        <RowStyle Font-Bold="False" Font-Names="Verdana" Font-Size="Small" HorizontalAlign="Left"
                                            VerticalAlign="Top" />
                                        <Columns>
                                            <asp:BoundField DataField="EV_SITE" HeaderText="Lugar ng Maagang Botohan" HeaderStyle-Width="240px" HeaderStyle-HorizontalAlign="left" HtmlEncode="false">
                        ...
                        <asp:Table ID="tblDaily" runat="server" BorderStyle="None" BorderWidth="0" CellPadding="2"
                            ...
                            <asp:TableRow ID="rNLV1" runat="server">
                                <asp:TableCell HorizontalAlign="Center">
                                    <font size="medium"><strong>Pagboboto sa Loob ng Opisina ng North Las Vegas</strong></font><br />
                                    <br />
                            ...
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="Center">
                                    <asp:Label ID="lblWeek1" runat="server" Font-Bold="true" Font-Size="medium" Text="Pang-araw-araw ng boto - Pang Unang Linggo"></asp:Label><br />
                                    <br />
                            ...
                            <asp:TableRow ID="rWeek2" runat="server">
                                <asp:TableCell HorizontalAlign="Center">
                                    <font size="medium"><strong>Pang-araw-araw ng boto - Pangalawang Linggo</strong></font><br />
                                    <br />
