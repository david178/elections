...
<%--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">--%>
  ...
  <body id="theBody_sp" ng-app="main" ng-controller="mainController" >
    <form id="frmMain" runat="server">
        
     <!-- header DATA -->
     <asp:SqlDataSource ID="sqlHeaderParms" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
        ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT ELECTION_TITLE_SP, ELECTION_DATE, DECODE(RESULTS_MODE,NULL,NULL,'<strong>'||RESULTS_MODE||'</strong><br>')||'Updated '||(SELECT TO_CHAR(MAX(REPORT_DATE),'MM/DD/YYYY HH12:MI AM') FROM ELECTION_RESULTS) AS RESULTS_MODE,DECODE(RESULTS_MSG,NULL,NULL,'<br>'||RESULTS_MSG) AS RESULTS_MSG FROM ELECTION_RESULTS_PARMS">
    </asp:SqlDataSource>
     <!-- elec mode DATA -->
    <asp:SqlDataSource ID="sqlElecMode" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
        ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT ELECTION_TITLE_SP, ELECTION_DATE_SP, ' '||DECODE(RESULTS_MODE, 'Unofficial Results', 'Resultados No Oficiales', 'Unofficial Final Results', 'Resultados Finales No Oficiales', 'Official Final Results', 'Resultados Finales Oficiales') ||' '||'  ' AS RESULTS_MODE_SP, DECODE(RESULTS_MSG_SP,NULL,NULL,'<br>'||RESULTS_MSG_SP) AS RESULTS_MSG_SP FROM ELECTION_RESULTS_PARMS">
    </asp:SqlDataSource>  
    <!-- last update DATA -->
    <asp:SqlDataSource ID="sqlLastUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
       ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT ELECTION_TITLE_SP, ELECTION_DATE, DECODE(RESULTS_MODE,NULL,NULL,'<strong></strong>')||'Actualizado '||(SELECT TO_CHAR(MAX(REPORT_DATE),'FMMM/DD/YY HH:MI AM') FROM ELECTION_RESULTS_STAGING) AS RESULTS_MODE_SP, DECODE(RESULTS_MSG_SP,NULL,NULL,'<br>'||RESULTS_MSG_SP) AS RESULTS_MSG_SP FROM ELECTION_RESULTS_PARMS">
    </asp:SqlDataSource>    
    ...
    <div id="modalShade">
        ...
        <div id="refinePopUp" class='mobileOverflow'>
              ...
              <div id="refinePopUp_Top">
                 ...
                 <label style="font-size:16px;">Refinar</label>
              </div>
              ...
              <div id="refinePopUp_Mid">
                  <div id="refinePopUp_MidInner">
                    ...
                    <div class=“centerPull”>
                      <!-- Show All Link -->
                      <a class="bold"  ng-click="showAllResults()" >Todo&nbsp</a>
                      <div style="font-weight: bold; display: inline-block; ">/</div>
                      <!-- None Link -->
                      <a class="bold"  ng-click="showNoResults()" >&nbspNinguno</a>
                    </div>
                  ...
                  <ul>
                     <li >
  					...
  					<label for="turnoutBox" name="turnoutBox_lbl" class="css-label">&nbspParticipación</label>
                      </div>
                    </li>
                    <li>
                        <div class=“setting”>
                      <input id="congressBox" class="css-checkbox" type="checkbox" ng-model="congress" ng-change="storageChange(congress, 'congress')" />
  					<label for="congressBox" name="congressBox_lbl" class="css-label">&nbspCongreso</label>
                      </div>
                    </li>
                    <li>
                        <div class=“setting”>
                        <input id="governorBox" class="css-checkbox" type="checkbox" ng-model="governor" ng-change="storageChange(governor, 'governor')" />
  					<label for="governorBox" name="governorBox_lbl" class="css-label">&nbspGobernador</label>
                         </div>
                    </li>
                      ...
                      <li>
  					 ...
  					 <label for="secretaryBox" name="secretaryBox_lbl" class="css-label">&nbspSecretario</label>
                      </div>
                     </li>
                     <li>
                        <div class=“setting”>
                       <input id="treasurerBox" class="css-checkbox" type="checkbox" ng-model="treasurer" ng-change="storageChange(treasurer, 'treasurer')" />
  					 <label for="treasurerBox" name="treasurerBox_lbl" class="css-label">&nbspSt Tesorero</label>
                      </div>
                     </li>
                    <li>  
                        <div class=“setting”>
                    ...
                    <li>
  					...
  					<label for="administratorBox" name="administratorBox_lbl" class="css-label">&nbspAdministrador</label>
                         </div>
                    </li>
                     <li>
                        <div class=“setting”>
                       <input id="supremeBox" class="css-checkbox" type="checkbox" ng-model="supreme" ng-change="storageChange(supreme, 'supreme')" />
  					 <label for="supremeBox" name="supremeBox_lbl" class="css-label">&nbspSuprema</label>
                      </div>
                     </li>
              ...
              <div id="refinePopUp_Bottom">
                  <!-- Featured Only Link -->
                  <a class="bold" id="bluelink2" ng-click="defaultSettings()" >destacado</a> | <!-- style="display:inline;" -->
                  <!-- Default button -->
          ...
          <div class="navbar-header">
            ...
            <a href="" class="navbar-brand"><img id="CountyLogo" title="Visit the County's Homepage" alt="Visit the County's Homepage" src="resources/img_icons/brightened2ico.ico" />
                    ...
                    <asp:FormView ID="headerfrmParams" runat="server" DataSourceID="sqlHeaderParms" Width="100%"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="ELECTION_TITLE_SPLabel" runat="server" Text='<%# Eval("ELECTION_TITLE_SP") %>'
            ...
            <nav class="collapse navbar-collapse " role="navigation">
              <ul class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <i class="fa fa-bar-chart-o" style="margin-right:8px;" ></i>Estatales</a>
                  </li>
                  <li>
                      <a target="_blank" href="http://www.clarkcountynv.gov/Depts/election_sp/Pages/default.aspx">
                      <i class="fa fa-bookmark" style="margin-right:8px;" ></i>Completo</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://redrock.clarkcountynv.gov/electionresults/enr_sp.aspx">
                        <i class="fa fa-print" style="margin-right:8px;" ></i>Imprimir</a>
                      </li>
                    </ul>
                  </nav>
                </div>
              ...
              <div class="col-md-9">
                ...
                <div class="headerAdjust"  id="headDescription" >
                  ...
                  <asp:FormView ID="headerfrmParams2" runat="server" DataSourceID="sqlElecMode" Width="100%"
                        ...
                        <ItemTemplate>
                                <!-- Elec Mode Tag -->
                                <div class="elecmodeHeader">Clark County, NV</div> <div style="display:inline-block">&nbsp;<i class="fa fa-ellipsis-v fa-md"></i> &nbsp; <asp:Label ID="RESULTS_MODELabel" runat="server" Text='<%# Bind("RESULTS_MODE_SP") %>' 
                    ...
                    <asp:FormView ID="headerfrmParams3" runat="server" DataSourceID="sqlLastUpdate" Width="100%"
                        ...
                        <ItemTemplate>
                            ...
                            <!-- Manual Refresh link -->
                            <a href="javascript:history.go(0)">Página de actualización</a>
                            <br />
                        </ItemTemplate>
                    </asp:FormView>

                    <i style="font-size:12px; color:gray;">Actualización de la página 30 minutos.</i>

                  <br/><br/>

                  Estatales disponible <a target="_blank" href="http://www.silverstateelection.com/" >Secretario de Estado sitio web.</a>
                    ...
                    <div id="noContestAlert" class="alert alert-info" role="alert">
                        <strong>Aviso! </strong> 
                        Asegúrese de aprovechar el <a ng-click="showAllResults()" class="alert-link">  Ver todo </a>, o elegir <a ng-click="showPopUp()" class="alert-link">  Refinar </a> para mostrar concursos.
                    </div>
                     ...
                     <div id="quickDirect">
                         ...
                         <div class="btn-group" style="display: inline-block;">
                             <a ng-click="hideTags('turnout')" ng-show="turnout" class="btn btn-default  cssFade" style="background-color: #0d77b6 !important; color: white !important;">participación <i  class="fa fa-times-circle" ></i></a> <!-- href="#turnoutSec" -->
                             <a ng-click="hideTags('congress')" ng-show="congress" class="btn btn-default cssFade"  style="background-color: #0d77b6 !important; color: white !important;">congreso <i  class="fa fa-times-circle"></i></a> <!-- href="#congressSec" -->
                             ...
                             <a ng-click="hideTags('secretary')" ng-show="secretary" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">secretario <i  class="fa fa-times-circle"></i></a> <!-- href="#secretarySec" -->
                             <a ng-click="hideTags('treasurer')" ng-show="treasurer" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">st tesorero <i  class="fa fa-times-circle"></i></a> <!-- href="#treasurerSec" -->
                             <a ng-click="hideTags('controller')" ng-show="controller" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">controlador <i  class="fa fa-times-circle"></i></a> <!-- href="#controllerSec" -->
                             <a ng-click="hideTags('attorney')" ng-show="attorney" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">procurador <i  class="fa fa-times-circle"></i></a> <!-- href="#attorneySec" -->
                             ...
                             <a ng-click="hideTags('assembly')" ng-show="assembly" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">montaje <i  class="fa fa-times-circle"></i></a> <!-- href="#assemblySec" -->
                             <a ng-click="hideTags('county')" ng-show="county" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">condado <i  class="fa fa-times-circle"></i></a> <!-- href="#countySec" -->
                             ...
                             <a ng-click="hideTags('supreme')" ng-show="supreme" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">suprema <i  class="fa fa-times-circle"></i></a> <!-- href="#supremeSec" -->
                             ...
                             <a ng-click="hideTags('judge')" ng-show="judge" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">juez <i  class="fa fa-times-circle"></i></a> <!-- href="#judgeSec" -->
                             <a ng-click="hideTags('regent')" ng-show="regent" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">regente <i  class="fa fa-times-circle"></i></a> <!-- href="#regentSec" -->
                             <a ng-click="hideTags('board')" ng-show="board" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">bordo <i  class="fa fa-times-circle"></i></a> <!-- href="#boardSec" -->
                             <a ng-click="hideTags('trustee')" ng-show="trustee" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">fiduciario <i  class="fa fa-times-circle"></i></a> <!-- href="#trusteeSec" -->
                             ...
                             <a ng-click="hideTags('peace')" ng-show="peace" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">paz <i  class="fa fa-times-circle"></i></a> <!-- href="#peaceSec" -->
                             <a ng-click="hideTags('question')" ng-show="question" class="btn btn-default cssFade"   style="background-color: #0d77b6 !important; color: white !important;">pregunta <i  class="fa fa-times-circle"></i></a> <!-- href="#questionSec" -->
                               ...
                               <a id="seeAllLink" title="" ng-click="showAllResults()" href="" style="display: inline-block; font-weight:bold; margin-left:6px !important;" > <!-- display:inline-block; float:left;  -->
                                  Ver todo <i class="fa fa-chevron-right"></i> <!-- <i class="fa fa-chevron-circle-right"></i> --> <!-- ng-show="allLink"  -->
                               </a> 
                ...
                <hr />
                <!-- Turnout Header -->
                <h2 id="turnoutHeader" class="flag" style="line-height: 1.428571429 !important;">Participación</h2>
                <br/>
                            ...
                            <asp:TemplateField ShowHeader="False" ItemStyle-BorderStyle="None">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblVoters" runat="server" Text='<%# Eval("CONTEST_TOTAL") %>' Font-Bold="True"
                                        Font-Names="Trebuchet MS"></asp:Label><strong>&nbsp;Votantes</strong>  <%--<i class="icon-flag icon-4x pull-left icon-border"></i>--%>
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
                                        ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT CANDIDATE_ORDER, UPPER(DECODE(CANDIDATE_FULL_NAME, 'Election Day Turnout', 'Votación el Día Electoral', 'Early Vote Turnout', 'Votación Temprana', 'Mail Turnout', 'Votación por Correo', CANDIDATE_FULL_NAME)) CANDIDATE_FULL_NAME, TRIM(TO_CHAR(TOTAL,'FM999,999')) AS VOTES, TRIM(TO_CHAR(CONTEST_TOTAL,'FM999,999')) AS CONTEST_TOTAL FROM ENR.ELECTION_RESULTS_STAGING WHERE UPPER(CONTEST_FULL_NAME)=:OFFICE ORDER BY TO_NUMBER(CANDIDATE_ORDER)">
                                        <SelectParameters>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        Font-Size="10pt" OnRowDataBound="GridView2_RowDataBound" ShowHeader="True" ShowFooter="True" CssClass="tableFontAdjust table ng-scope ng-table" GridLines="None">
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="CANDIDATE_FULL_NAME" HeaderText="Método de Votación" SortExpression="CANDIDATE_FULL_NAME"
                                                    >
...
<%--                <!-- MUNI TURNOUT -->
                ...
                <!-- Featured Races -->
                <h2  id="featuredRacesHeader" class="flag" style="line-height: 1.428571429 !important;">Contiendas</h2>
...
<%--                <a id="refineButton" class="contentright" title="" ng-click="showPopUp()"  href="" style="font-weight:bold;" > <!-- margin-left:6px !important; --> <!-- display:inline-block; float:left;  -->
                    Refinar <i class="fa fa-chevron-circle-right"></i>
                </a>--%>
                <div class="row">
                ...
                <asp:SqlDataSource ID="SqlSheriff" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
                    ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT DISTINCT UPPER(C.CONTEST_FULL_NAME_SP) AS CONTEST_FULL_NAME, S.CONTEST_ORDER, S.TOTAL_PRECINCTS, S.PROCESSED_DONE, DECODE((TO_NUMBER(S.PROCESSED_DONE) / TO_NUMBER(S.TOTAL_PRECINCTS)), 1,'100',TRIM(TO_CHAR((TO_NUMBER(S.PROCESSED_DONE) / TO_NUMBER(S.TOTAL_PRECINCTS) * 100), '990.00')))||' %' AS PCT_DONE, DECODE(S.CONTEST_TYPE,'4','Respuesta','Candidato(a)') AS CONTEST_TYPE, DECODE(C.CONTEST_MSG_SP,NULL,'VOTE POR '||S.VOTE_FOR,UPPER(C.CONTEST_MSG_SP)||'<BR>VOTE POR '||S.VOTE_FOR) AS CONTEST_MSG FROM ENR.ELECTION_RESULTS S,ENR.ELECTION_RESULTS_CONTESTS C WHERE TO_NUMBER(S.CONTEST_TYPE) >= 0 AND C.CONTEST_FULL_NAME = S.CONTEST_FULL_NAME  AND  UPPER(C.CONTEST_FULL_NAME) LIKE '%SHERIFF%' ORDER BY TO_NUMBER(S.CONTEST_ORDER)">
                </asp:SqlDataSource>
                <!-- SQL by Peace Races -->
                        ...
                        <asp:TemplateField ShowHeader="False" ItemStyle-BorderStyle="None">
                            <ItemTemplate>
                                ...
                                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5"
                                    ...
                                    <RowStyle VerticalAlign="Top" Wrap="False" />
                                    <Columns>
                                        <asp:BoundField DataField="CANDIDATE_FULL_NAME" HeaderText="Candidato(a)/Respuesta" SortExpression="CANDIDATE_FULL_NAME"
                                            HeaderStyle-HorizontalAlign="left" > 
                                        ...
                                        <asp:BoundField DataField="VOTES" HeaderText="Votos" HeaderStyle-HorizontalAlign="Right" >
                                            <ItemStyle Wrap="False" Width="110px" HorizontalAlign="right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="CONTEST_TOTAL" HeaderText="" Visible="False"></asp:BoundField>
               ...
               <div id="divQuestion" runat="server" style="border-style: none; text-align: center;" >
                ...
                <asp:SqlDataSource ID="SqlQuestion" runat="server" ConnectionString="<%$ ConnectionStrings:ELECP-ELWEB %>"
                    ProviderName="<%$ ConnectionStrings:ELECP-ELWEB.ProviderName %>" SelectCommand="SELECT DISTINCT UPPER(C.CONTEST_FULL_NAME_SP) AS CONTEST_FULL_NAME, S.CONTEST_ORDER, S.TOTAL_PRECINCTS, S.PROCESSED_DONE, DECODE((TO_NUMBER(S.PROCESSED_DONE) / TO_NUMBER(S.TOTAL_PRECINCTS)), 1,'100',TRIM(TO_CHAR((TO_NUMBER(S.PROCESSED_DONE) / TO_NUMBER(S.TOTAL_PRECINCTS) * 100), '990.00')))||' %' AS PCT_DONE, DECODE(S.CONTEST_TYPE,'4','Response','Candidate') AS CONTEST_TYPE, DECODE(C.CONTEST_MSG_SP,NULL,'VOTE FOR '||S.VOTE_FOR,UPPER(C.CONTEST_MSG_SP)||'<BR>VOTE FOR '||S.VOTE_FOR) AS CONTEST_MSG FROM ENR.ELECTION_RESULTS_STAGING S,ENR.ELECTION_RESULTS_CONTESTS C WHERE TO_NUMBER(S.CONTEST_TYPE) >= 0 AND C.CONTEST_FULL_NAME = S.CONTEST_FULL_NAME  AND  UPPER(C.CONTEST_FULL_NAME) LIKE '%QUESTION%' ORDER BY TO_NUMBER(S.CONTEST_ORDER)">
                </asp:SqlDataSource>
